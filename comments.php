...
?>
	...
	<?php if ( have_comments() ) : ?>
		<h2 class="comments-title">
			<?php
				printf( _nx( 'One thought on &ldquo;%2$s&rdquo;', '%1$s thoughts on &ldquo;%2$s&rdquo;', get_comments_number(), 'comments title', 'motrton_two' ),
		...
		<nav role="navigation" id="comment-nav-above" class="site-navigation comment-navigation">
			...
			<div class="nav-next"><?php next_comments_link( __( 'Newer Comments &rarr;', 'motrton_two' ) ); ?></div>
	...
	?>
		<p class="nocomments"><?php _e( 'Comments are closed.', 'motrton_two' ); ?></p>
	<?php endif; ?>
